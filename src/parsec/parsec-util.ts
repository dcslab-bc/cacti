...
export class ParsecUtil {
    ...
    public async invokeParsecContracts(log: Logger, invocationType: EthContractInvocationType, parsecApi: ParsecApi, keychainId: string, contractName: string, methodName: string, address?: string, privateKey?: string, params?: any[]): Promise<any> {
    ...
    // own parsec htlc
    public async ownParsecHtlc(log: Logger, 
    ...
    public async counterpartyParsecHtlc(log: Logger, 
        parsecApi: HtlcCoordinatorParsecApi, 
        connectorInstanceId: string, 
        keychainId: string, 
        htlcId: string, 
    ...
    // withdraw htlc
    public async withdrawParsecCounterparty(log: Logger, 
        parsecApi: HtlcCoordinatorParsecApi, 
        connectorInstanceId: string, 
        keychainId: string, 
        htlcId: string, 
