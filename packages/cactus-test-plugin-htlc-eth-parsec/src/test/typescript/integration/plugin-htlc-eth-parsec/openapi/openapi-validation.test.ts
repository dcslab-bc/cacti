...
import { PluginHtlcEthParsec } from "@hyperledger/cactus-plugin-htlc-eth-parsec";
...
const testCase = "Test cactus-plugin-htlc-eth-parsec openapi validation";
...
test(testCase, async (t: Test) => {
  ...
  const OAS = (pluginHtlc as PluginHtlcEthParsec).getOpenApiSpec();
