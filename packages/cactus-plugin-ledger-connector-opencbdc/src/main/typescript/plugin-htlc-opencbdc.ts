...
import { NewContractRequest, PluginLedgerConnectorOpenCBDC } from ".";
import HashTimeLockJSON from "../json/HashedTimeLockContract.json";
import {
  InitializeRequest,
  RefundRequest,
  WithdrawRequest,
...
export interface IPluginHtlcOpenCBDCOptions extends ICactusPluginOptions {
  keychainId?: string;
  instanceId: string;
...
export class PluginHtlcOpenCBDC
  ...
  public static readonly CLASS_NAME = "PluginHtlcOpenCBDC";
  ...
  constructor(public readonly opts: IPluginHtlcOpenCBDCOptions) {
  ...
  public get className(): string {
    return PluginHtlcOpenCBDC.CLASS_NAME;
  }
  ...
  public getPackageName(): string {
    return "@hyperledger/cactus-plugin-htlc-opencbdc";
  }
  ...
  public async initialize(
    ...
    ) as PluginLedgerConnectorOpenCBDC;
