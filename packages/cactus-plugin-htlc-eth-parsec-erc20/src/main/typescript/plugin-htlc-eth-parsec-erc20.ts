...
export interface IPluginHtlcEthParsecErc20Options extends ICactusPluginOptions {
  keychainId?: string;
  instanceId: string;
  logLevel?: LogLevelDesc;
  pluginRegistry: PluginRegistry;
}
export class PluginHtlcEthParsecErc20
  implements ICactusPlugin, IPluginWebService
{
  public static readonly CLASS_NAME = "PluginHtlcEthParsecErc20";
  ...
  constructor(public readonly opts: IPluginHtlcEthParsecErc20Options) {
  ...
  public get className(): string {
    return PluginHtlcEthParsecErc20.CLASS_NAME;
  }
  ...
  public getPackageName(): string {
    return "@hyperledger/cactus-plugin-htlc-eth-parsec-erc20";
  }
