...
export interface IOpenCBDCMpTestLedgerOptions {
...
export class OpenCBDCMpTestLedger {
  public static readonly CLASS_NAME = "OpenCBDCMpTestLedger";
  ...
  public get className(): string {
    return OpenCBDCMpTestLedger.CLASS_NAME;
  }

  constructor(public readonly options: IOpenCBDCMpTestLedgerOptions) {
