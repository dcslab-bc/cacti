...
export interface IParsecMpTestLedgerOptions {
...
export class ParsecMpTestLedger {
  public static readonly CLASS_NAME = "ParsecMpTestLedger";
  ...
  public get className(): string {
    return ParsecMpTestLedger.CLASS_NAME;
  }

  constructor(public readonly options: IParsecMpTestLedgerOptions) {
