...
export interface IParsecTestLedgerConstructorOptions {
...
export const PARSEC_TEST_LEDGER_DEFAULT_OPTIONS = Object.freeze({
...
export const PARSEC_TEST_LEDGER_OPTIONS_JOI_SCHEMA: Joi.Schema =
  Joi.object().keys({
...
export class ParsecTestLedger implements ITestLedger {
  ...
  constructor(
    public readonly options: IParsecTestLedgerConstructorOptions = {},
  ) {
    if (!options) {
      throw new TypeError(`ParsecTestLedger#ctor options was falsy.`);
    }
    this.containerImageVersion =
      options.containerImageVersion ||
      PARSEC_TEST_LEDGER_DEFAULT_OPTIONS.containerImageVersion;
    this.containerImageName =
      options.containerImageName ||
      PARSEC_TEST_LEDGER_DEFAULT_OPTIONS.containerImageName;
    this.rpcApiHttpPort =
      options.rpcApiHttpPort ||
      PARSEC_TEST_LEDGER_DEFAULT_OPTIONS.rpcApiHttpPort;
    this.rpcApiWsPort =
      options.rpcApiWsPort || PARSEC_TEST_LEDGER_DEFAULT_OPTIONS.rpcApiWsPort;
    this.envVars =
      options.envVars || PARSEC_TEST_LEDGER_DEFAULT_OPTIONS.envVars;
  ...
  public async getParsecKeyPair(): Promise<IKeyPair> {
  ...
  private validateConstructorOptions(): void {
    const validationResult = PARSEC_TEST_LEDGER_OPTIONS_JOI_SCHEMA.validate({
