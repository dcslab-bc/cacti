...
import HashTimeLockJSON from "../../../../../../../cactus-plugin-htlc-eth-parsec-erc20/src/main/solidity/contracts/HashedTimeLockContract.json";

import { installOpenapiValidationMiddleware } from "@hyperledger/cactus-core";
import { PluginHtlcEthParsecErc20 } from "@hyperledger/cactus-plugin-htlc-eth-parsec-erc20";
...
const testCase = "Test cactus-plugin-htlc-eth-parsec-erc20 openapi validation";
...
test(testCase, async (t: Test) => {
  ...
  const parsecTestLedger = new BesuTestLedger({ logLevel });
  ...
  const pluginOptions: IPluginHtlcEthParsecErc20Options = {
    logLevel,
    instanceId: uuidv4(),
    pluginRegistry,
  };

  const factoryHTLC = new PluginFactoryHtlcEthParsecErc20({
    pluginImportType: PluginImportType.Local,
  });
  ...
  const OAS = (pluginHtlc as PluginHtlcEthParsecErc20).getOpenApiSpec();
