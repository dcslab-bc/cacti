...
import { PluginHtlcEthParsec } from "../plugin-htlc-eth-parsec";
import OAS from "../../json/openapi.json";

export interface IGetSingleStatusEndpointOptions {
  logLevel?: LogLevelDesc;
  plugin: PluginHtlcEthParsec;
}
export class GetSingleStatusEndpoint implements IWebServiceEndpoint {
  ...
  public get oasPath(): (typeof OAS.paths)["/api/v1/plugins/@hyperledger/cactus-plugin-htlc-eth-parsec/get-single-status"] {
    return OAS.paths[
      "/api/v1/plugins/@hyperledger/cactus-plugin-htlc-eth-parsec/get-single-status"
    ];
  }
