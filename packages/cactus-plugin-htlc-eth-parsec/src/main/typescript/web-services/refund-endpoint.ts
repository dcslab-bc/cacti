...
export class RefundEndpoint implements IWebServiceEndpoint {
  ...
  public get oasPath(): (typeof OAS.paths)["/api/v1/plugins/@hyperledger/cactus-plugin-htlc-eth-parsec/refund"] {
    return OAS.paths[
      "/api/v1/plugins/@hyperledger/cactus-plugin-htlc-eth-parsec/refund"
    ];
  }
