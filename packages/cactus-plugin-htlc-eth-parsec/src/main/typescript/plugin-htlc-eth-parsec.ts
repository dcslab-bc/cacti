...
export interface IPluginHtlcEthParsecOptions extends ICactusPluginOptions {
  logLevel?: LogLevelDesc;
  instanceId: string;
  pluginRegistry: PluginRegistry;
}
export class PluginHtlcEthParsec implements ICactusPlugin, IPluginWebService {
  public static readonly CLASS_NAME = "PluginHtlcEthParsec";
  private readonly instanceId: string;
  private readonly pluginRegistry: PluginRegistry;
  private readonly estimatedGas = 6721975;
  private endpoints: IWebServiceEndpoint[] | undefined;

  constructor(public readonly opts: IPluginHtlcEthParsecOptions) {
  ...
  public get className(): string {
    return PluginHtlcEthParsec.CLASS_NAME;
  }
  ...
  public getPackageName(): string {
    return "@hyperledger/cactus-plugin-htlc-eth-parsec";
  }
